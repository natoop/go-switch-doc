...
Review [Create API Token](../register/4-token.md), we need to create a **Codex** group token in GoSwitcher, then click the copy button on the right and fill the key into the "xxx" part and save
